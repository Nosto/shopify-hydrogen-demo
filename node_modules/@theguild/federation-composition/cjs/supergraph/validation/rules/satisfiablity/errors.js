...
exports.LazyErrors = exports.SatisfiabilityError = void 0;
...
class LazyErrors {
    ...
    toArray() {
        return this.lazyError.flatMap((error) => error.get()).filter(helpers_js_1.isDefined);
    }
    isEmpty() {
        return this.lazyError.length === 0;
    }
}
exports.LazyErrors = LazyErrors;
