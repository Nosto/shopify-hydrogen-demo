...
export type ExpressionTerm = IdentNode | HexNode | NumberNode | OperatorNode | FunctionNode;
...
export declare const numberNode: <T extends Unit | Percentage | null>(value: number, unit: T) => NumberNode<T>;
...
export type ASTNode = IdentNode | HexNode | NumberNode | OperatorNode | FunctionNode | ExpressionNode;
/**
