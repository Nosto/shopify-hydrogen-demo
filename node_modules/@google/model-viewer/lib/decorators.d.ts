...
export type IntrinsicsFactory<T extends Intrinsics<Array<Unit>>, U extends ReactiveElement> = (element: U) => T;
 ...
 * static).
 */
export declare const style: <T extends Intrinsics<Array<Unit>>, U extends ReactiveElement>(config: StyleDecoratorConfig<T, U>) => <U extends (typeof ReactiveElement)["prototype"]>(proto: U_1, propertyName: string) => void;
