 ...
 */
export declare const LoadingMixin: <T extends Constructor<ModelViewerElementBase>>(ModelViewerElement: T) => Constructor<LoadingInterface, LoadingStaticInterface> & T;
