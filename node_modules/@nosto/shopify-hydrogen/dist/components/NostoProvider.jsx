...
export function NostoProvider({ children, currency: currencyProp, nonce, ...props }) {
    ...
    const marketId = propMarketId != null
    ...
    return (<ClientOnly>
      <React.Suspense fallback={null}>
        <NostoProviderInner {...props} {...(shopifyMarkets ? { shopifyMarkets } : {})} currentVariation={currentVariation} scriptLoader={scriptLoader}>
          <NostoSession />
          {children}
        </NostoProviderInner>
      </React.Suspense>
